...
<body>
   ...
   <%--
   		* JSP를 이루는 구성
   		...
   		2. 지시어 : jsp페이지 정보에대한 내용을 표현한다거나 또 다른페이지를 포현할떄 사용\
   				  jsp기능을 확장시키는 라이브러리를 등록할 때 사용

		3. 액션태크 : jsp페이지에서 어떤 동작을 하도록 지시하는 태그
					xml기술을 이용하여 기존의 jsp문법을 확장하는기술을 제공하는 태그
    ...
    <p>
   	...
   	<p>
   		...
   		<%--<%@ taglib prefix="접두어" uri="라이프러리파일상의 uri주소" --%>
   	</p>
   	
   	<h3>Custom Action Tag</h3>
   	<h4>1. JSTL Core Library</h4>
   	<p>
   		변수와 조건문, 반복문과 같은 로직과 관련된 문법을 제공
   	</p>
