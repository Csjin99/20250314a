...
<body>
	...
	<p>
		...
		(fmt:formatNumber value="출력할 값" [groupingUsed="true|false" type="percent | currency" currencySybol="문자"])
	</p>
	...
	currency : <fmt:formatNum ber value="${num3}" type="currency" currencySymbol="$" /> <br>
