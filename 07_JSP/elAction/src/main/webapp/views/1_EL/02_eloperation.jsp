...
<body>
    ...
    sOne과 sTwo가 일치하는가? ${sOne != sTwo} 또는 ${sOne ne sTwo} <br>

    big에 담긴 값과 10이 일치하는가? ${big == 10} 또는 ${big eq 10} <br>

    <%-- el구문아네서 문자열 리터럴값은 "",''를 구분하지 않음 --%>
    sThree과 "hello"가 일치하는가? ${sThree == "hello"} 또는 ${sThree eq 'hello'} <br>
    ...
    pTwo이 null입니까? ${pTwo != null} 또는 ${pTwo ne null} 또는 ${not empty pTwo} <br>
