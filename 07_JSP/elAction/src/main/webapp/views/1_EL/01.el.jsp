...
<body>
    ...
    <p>
        ...
        EL은 JSP의 scope를 구문하지않고 자동으로 모든 scope의 키값을 검색하여 존재하는 경우 그 값을 가져옴
    </p>
    ...
    <p>EL은 공유범위가 가장 작은 scope부터 해당 키값을 검색한다(page -> request -> sessiion -> application)</p>
    test값 : ${test}

    <h4>직접 scope를 지정하여 접근</h4>
    <% pageContext.setAttribute("scope","page"); %>

    pageScope : ${scope}, ${pageScope.scope} <br>
    requestScope : ${requestScope.scope} <br>
    sessionScope : ${sessiionScope.scope} <br>
