 ...
 * 저장위치를 구분하여 명확하게 접근할 수 있도록 해주는것
 ...
 * static변수와 static메서드는 정적 메모리를 사용하여 프로그램 실행시점에 따로 객체생성없이
 * 메모리가 생성되며, 이를 모든객체가 공유해서 사용한다.
 * 
 * 클래스(static)변수 : 한 클래스에서 공통적인 값을 유지해야할 때 사용
 * 클래스(static)메서드 : 인스턴스변수를 사용할 수 없으므로 인스턴스와 관계없는 메서드를 클래스메서드로 사용한다.
 * 
 */
...
public class Run {
	...
	public static void main(String[] args) {
		/*
		Book b1 = new Book("이게되네? 챗GPT","IT","오힘찬", 120);
		Book b2 = new Book("Easy 딥러닝","IT","혁펜하임", 200);
		Book b3 = new Book("혼자공부하는 컴퓨터 구조 + 운영체제","IT","강민철", 300);
