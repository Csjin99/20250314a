...
public class LotteryMenu {
	...
	public void insertObject() {
		...
		for(int i =0; i< num; i ++) {
			...
			boolean inlo = lc.insertObject(new Lottery(name,phone));
	...
	public void searchWinner() {
		...
		boolean swi = lc.searchWinner(new Lottery(name,phone));
