...
public class SetRun {
	...
	public static void main(String[] args) {
		...
		System.out.println(hs1); //저장순서를 유지하지 않는다.( 중복된데이터(동일객체) 보관 불가.
		...
		hs2.add(new Student("최성진",23, 80));
		hs2.add(new Student("홍길동",28, 45));
		hs2.add(new Student("홍길남",27, 60));
		hs2.add(new Student("최성진",23, 80));
		 ...
		 * hashCode : 해당 객체의 주소값을 가지고 10진수의 형태의 해시코드로 반환
		 */
		...
		// hasNext() : 다음요소가 있는지 알려줌(true/false)
		...
		//3. ArrayList에 담아준 다음 ArrayList에 반복적으로 돌아가며 접근하는 방법
