...
public class Run {
	 ...
	 * 
	 * 오버라이딩
	 * -자식클래스가 상속받고있는 부모 클래스이 메서드를 재정의하는 것
	...
	public static void main(String[] args) {
		...
		//갹체가 생성되어있다면 객체정보를 보기위해서 참조변수를 출력하는 순간 무조건 toString메서드가 호출된다.
		//참조변수에 객체의 주소가 없고 null이라면 null이 호출된다.
