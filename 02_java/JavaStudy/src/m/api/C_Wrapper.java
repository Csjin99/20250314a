...
public class C_Wrapper {
	/*
	 * Wrapper클래스
	 * -> 기본자료형을 객체로 포장해줄 수 있느 클래스가 래퍼클래스이다.
	 * 
	 * 
	 * boolean(Boolean)
	 * char(Character)
	 ...
	 * => 원시타입을 객체로 표현해야할 경우
	 * 		- 메서드 호출해야할 때
	 * 			->메서드의 매개변수가 기본자료형이 아닌 객체타입만 요구될 때
	 * 		- 다형셩을 적용시키고 싶을때
	 * 
	 */
	...
	public void method01() {
		...
		System.out.println(i1.compareTo(i2)); // 두값을 비교해서 앞쪽이 크면 1반환, 뒤쪽이크면 -1 반환
		...
		//2.메서드 사용하지않고 바로 대임(Autounboxing)
		int num5 = i3;
